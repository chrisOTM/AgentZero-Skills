...
This skill includes the optimized market data collection script:
...
```bash
python good‑morning‑trader/scripts/market_data_optimized.py
```

For a lightweight validation step:

```bash
python -m py_compile good‑morning‑trader/scripts/market_data_optimized.py
```
